...
function handle_inspecciones_activas()
{
   ...
   inspecciones_completas.classList.add( "oculto" )
...
function handle_inspecciones_completas()
{
    ...
    document.querySelector( '#nav_inspecciones' ).classList.add( 'active' )
 document.querySelector( '#nav_dashboard' ).classList.remove( 'active' )
    //ocultar dashboard
  dashboard.classList.add( "oculto" )
...
function handle_dashboard()
{
   ...
   document.querySelector( '#nav_inspecciones' ).classList.remove( 'active' )
  document.querySelector( '#nav_dashboard' ).classList.add( 'active' )
