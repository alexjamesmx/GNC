...
var lamparas, lamparas_emergencia, senalizacion, pintura, herreria;
...
.then(res => {
    ...
    const {
        ...
        extintores_fecha_vencimiento:extintores_fecha_vencimiento_err,
        ...
        lamparas_emergencia_faltante:lamparas_emergencia_faltante_err,
        ...
        senalizacion_seguridad_faltante:senalizacion_seguridad_faltante_err,
        senalizacion_seguridad_estado:senalizacion_seguridad_estado_err,
    } = res.data.errors
        ...
        if(extintores_aro_seguridad_err) {
            ...
            extintores_aro_seguridad_error.innerHTML = extintores_aro_seguridad_err
        }
        else{
        ...
        if(extintores_fecha_vencimiento_err) { 
            ...
            extintores_fecha_vencimiento_error.innerHTML = extintores_fecha_vencimiento_err
        }
        else{
        ...
        if(extintores_tipo_agente_err) {
            ...
            extintores_tipo_agente_error.innerHTML = extintores_tipo_agente_err
        }
        else{
        ...
        if(herreria_observaciones_err) {
            ...
            herreria_observaciones_error.innerHTML = herreria_observaciones_err
        }
        else{
        ...
        if(extintores_ubicacion_err){
            ...
            extintores_ubicacion_error.innerHTML = extintores_ubicacion_err
        }else{
            console.log('ph no')
        ...
        if(lamparas_emergencia_estado_err){
            alert('Por favor, indica el estado de las lámparas de emergencia')
        }
        if(lamparas_emergencia_faltante_err){
            ...
            lamparas_emergencia_faltante_error.innerHTML = lamparas_emergencia_faltante_err
        }else{
        ...
        if(lamparas_emergencia_no_err){
            ...
            lamparas_emergencia_no_error.innerHTML = lamparas_emergencia_no_err
        }else{
        ...
        if(senalizacion_observaciones_err){
            ...
            senalizacion_observaciones_error.innerHTML = senalizacion_observaciones_err
        }else{
        ...
        if(senalizacion_seguridad_err){
            ...
            senalizacion_seguridad_error.innerHTML = senalizacion_seguridad_err
        }else{
        ...
        if(senalizacion_seguridad_faltante_err){
            ...
            senalizacion_seguridad_faltante_error.innerHTML = senalizacion_seguridad_faltante_err
        }else{
        ...
        if(senalizacion_seguridad_estado_err){
            alert('Por favor, indica el estado de la señalización de seguridad')
        }
...
no_extintores.addEventListener('change',() => {
    if(no_extintores.value === ''){
        ...
        no_extintores.classList.remove('is-valid')
        no_extintores.classList.add('is-invalid')
        no_extintores_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
    }
    else{
        no_extintores.classList.remove('is-invalid')
        no_extintores_error.innerHTML = ''
...
const extintores_tipo_agente = document.querySelector('#extintores_tipo_agente')
const extintores_tipo_agente_error =document.querySelector('#extintores_tipo_agente_error')
...
const extintores_fecha_vencimiento = document.querySelector('#extintores_fecha_vencimiento')
const extintores_fecha_vencimiento_error =document.querySelector('#extintores_fecha_vencimiento_error')
extintores_fecha_vencimiento.addEventListener('change',() => {
    if(extintores_fecha_vencimiento.value === ""){
        extintores_fecha_vencimiento.classList.remove('is-valid')
        extintores_fecha_vencimiento.classList.add('is-invalid')
        extintores_fecha_vencimiento_error.innerHTML = "Este campo es requerido"
    }
    else{
        extintores_fecha_vencimiento.classList.remove('is-invalid')
        extintores_fecha_vencimiento_error.innerHTML = ''
...
const extintores_presion_error =document.querySelector('#extintores_presion_error')
extintores_presion.addEventListener('change',() => {
    if(extintores_presion.value === ""){
        ...
        extintores_presion.classList.remove('is-valid')
        extintores_presion.classList.add('is-invalid')
        extintores_presion_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const extintores_aro_seguridad = document.querySelector('#extintores_aro_seguridad')
const extintores_aro_seguridad_error =document.querySelector('#extintores_aro_seguridad_error')
extintores_aro_seguridad.addEventListener('change',() => {
    if(extintores_aro_seguridad.value === ""){
        ...
        extintores_aro_seguridad.classList.remove('is-valid')
        extintores_aro_seguridad.classList.add('is-invalid')
        extintores_aro_seguridad_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const extintores_ubicacion_error =document.querySelector('#extintores_ubicacion_error')
extintores_ubicacion.addEventListener('change',() => {
    if(extintores_ubicacion.value === ""){
        ...
        extintores_ubicacion.classList.remove('is-valid')
        extintores_ubicacion.classList.add('is-invalid')
        extintores_ubicacion_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
lamparas_no.addEventListener('change',() => {
    if(lamparas_no.value === ""){
        ...
        lamparas_no.classList.remove('is-valid')
        lamparas_no.classList.add('is-invalid')
        lamparas_no_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const lamparas_faltante_error =document.querySelector('#lamparas_faltante_error')
lamparas_faltante.addEventListener('change',() => {
    if(lamparas_faltante.value === ""){
        ...
        lamparas_faltante.classList.remove('is-valid')
        lamparas_faltante.classList.add('is-invalid')
        lamparas_faltante_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const lamparas_emergencia_no = document.querySelector('#lamparas_emergencia_no')
const lamparas_emergencia_no_error =document.querySelector('#lamparas_emergencia_no_error')
lamparas_emergencia_no.addEventListener('change',() => {
    if(lamparas_emergencia_no.value === ""){
        ...
        lamparas_emergencia_no.classList.remove('is-valid')
        lamparas_emergencia_no.classList.add('is-invalid')
        lamparas_emergencia_no_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const lamparas_emergencia_faltante = document.querySelector('#lamparas_emergencia_faltante')
const lamparas_emergencia_faltante_error =document.querySelector('#lamparas_emergencia_faltante_error')
lamparas_emergencia_faltante.addEventListener('change',() => {
    if(lamparas_emergencia_faltante.value === ""){
        lamparas_emergencia_faltante.classList.remove('is-valid')
        lamparas_emergencia_faltante.classList.add('is-invalid')
        lamparas_emergencia_faltante_error.innerHTML = "Este campo es requerido"
    }
    else if(lamparas_emergencia_faltante.value.length > 255 ){  
        lamparas_emergencia_faltante.classList.remove('is-valid')
        lamparas_emergencia_faltante.classList.add('is-invalid')
        lamparas_emergencia_faltante_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const senalizacion_seguridad = document.querySelector('#senalizacion_seguridad')
const senalizacion_seguridad_error =document.querySelector('#senalizacion_seguridad_error')
senalizacion_seguridad.addEventListener('change',() => {
    if(senalizacion_seguridad.value === ""){
        ...
        senalizacion_seguridad.classList.remove('is-valid')
        senalizacion_seguridad.classList.add('is-invalid')
        senalizacion_seguridad_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const senalizacion_seguridad_faltante = document.querySelector('#senalizacion_seguridad_faltante')
const senalizacion_seguridad_faltante_error =document.querySelector('#senalizacion_seguridad_faltante_error')
senalizacion_seguridad_faltante.addEventListener('change',() => {
    if(senalizacion_seguridad_faltante.value === ""){
        senalizacion_seguridad_faltante.classList.remove('is-valid')
        senalizacion_seguridad_faltante.classList.add('is-invalid')
        senalizacion_seguridad_faltante_error.innerHTML = "Este campo es requerido"
    }
    else if(senalizacion_seguridad_faltante.value.length > 255 ){  
        senalizacion_seguridad_faltante.classList.remove('is-valid')
        senalizacion_seguridad_faltante.classList.add('is-invalid')
        senalizacion_seguridad_faltante_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const senalizacion_observaciones = document.querySelector('#senalizacion_observaciones')
const senalizacion_observaciones_error =document.querySelector('#senalizacion_observaciones_error')
senalizacion_observaciones.addEventListener('change',() => {
    if(senalizacion_observaciones.value === ""){
        ...
        senalizacion_observaciones.classList.remove('is-valid')
        senalizacion_observaciones.classList.add('is-invalid')
        senalizacion_observaciones_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const pintura_requiere_error =document.querySelector('#pintura_requiere_error')
pintura_requiere.addEventListener('change',() => {
    if(pintura_requiere.value === ""){
        ...
        pintura_requiere.classList.remove('is-valid')
        pintura_requiere.classList.add('is-invalid')
        pintura_requiere_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const herreria_requiere_error =document.querySelector('#herreria_requiere_error')
herreria_requiere.addEventListener('change',() => {
    if(herreria_requiere.value === ""){
        ...
        herreria_requiere.classList.remove('is-valid')
        herreria_requiere.classList.add('is-invalid')
        herreria_requiere_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
const herreria_observaciones = document.querySelector('#herreria_observaciones')
const herreria_observaciones_error =document.querySelector('#herreria_observaciones_error')
herreria_observaciones.addEventListener('change',() => {
    if(herreria_observaciones.value === ""){
        ...
        herreria_observaciones.classList.remove('is-valid')
        herreria_observaciones.classList.add('is-invalid')
        herreria_observaciones_error.innerHTML = "Este campo no puede tener más de 255 caracteres"
...
document.querySelector('#btn-cancelar').addEventListener('click', () => {
    ...
    console.log(route)
    const id = document.querySelector('#id_inspeccion').value
    const url= route[0].replace(':id', id)
    console.log(url)
