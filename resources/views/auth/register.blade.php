    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input id="name" class="tw-block tw-mt-1 tw-w-full" type="text" name="name"
            ...
            <div class="tw-mt-4">
                ...
                <x-text-input id="email" class="tw-block mt-1 tw-w-full" type="email" name="email"
            ...
            <div class="tw-flex tw-items-center tw-justify-end mt-4">
                <a class="tw-underline tw-text-sm tw-text-gray-600 tw-hover:text-gray-900 tw-rounded-md tw-focus:outline-none tw-focus:ring-2 tw-focus:ring-offset-2 tw-focus:ring-indigo-500"
                    href="{{ route('login') }}">
