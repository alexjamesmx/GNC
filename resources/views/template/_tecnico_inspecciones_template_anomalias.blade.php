       ...
       <div class="popup" id="popup">
           ...
           <form name="anomalias" id="form-anomalias" enctype="multipart/form-data"
               ...
               <div class="contenedor-inputs">
                   ...
                   <input id="form-foto" type="file" class="form-control" name="imagen" id="image" anomalia=1  accept=".png, .jpg, .jpeg" />
               ...
               <input id="tipo_inspeccion_id"type="hidden" value="" name="tipo_inspeccion_id">
