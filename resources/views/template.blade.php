                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                <img class="img-md rounded-circle" src="{{ asset('images/faces/face8.jpg') }}"
                                    alt="Profile image">
                                <p class="mb-1 mt-3 font-weight-semibold">Allen Moreno {{ Auth::user() }}</p>
                        ...
                        <a href="#" class="nav-link">
                            <div class="profile-image">
                                ...
                                <img class="img-xs rounded-circle"
                                    src="{{ Auth::user()->image ? asset('images/faces/' . Auth::user()->image . '') : asset('images/faces/face8.jpg') }}"
                                    alt="profile image">
                                <div class="dot-indicator bg-success"></div>
                            </div>
                            <div class="text-wrapper">
                                <p class="profile-name">Allen {{ Auth::user()->name }}</p>
                                <p class="designation">Premium user{{ Auth::user() }}</p>
                            </div>
                        </a>
                    </li>
