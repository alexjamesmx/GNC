                ...
                <form id="form-inspecciones" class="form-sample needs-validation" novalidate
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="extintores_no"name="extintores_no" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" placeholder="yyyy/dd/mm"
                                        name="extintores_fecha_vencimiento" id="extintores_fecha_vencimiento" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="extintores_aro_seguridad"
                                        id="extintores_aro_seguridad" />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="lamparas_no"id="lamparas_no" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <div class="form-radio flex justify-center w-1/2">
                                    <input type="radio" class="col-form-check-input" name="lamparas_estado"
                                        value="Buen estado">
                                    <label class="col-form-check-label"> Buen estado</label>
                                </div>
                                <div class="form-radio  flex justify-center w-1/2">
                                    <input type="radio" class="col-form-check-input lamparas" name="lamparas_estado"
                                        value="Mal estado" onclick="handleAnomalia('lamparas')">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <div class="form-radio flex justify-center w-1/2">
                                    <input type="radio" class="col-form-check-input" name="lamparas_emergencia_estado"
                                        value="Buen estado">
                                    <label class="col-form-check-label"> Buen estado </label>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="senalizacion_seguridad"
                                        id="senalizacion_seguridad" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Faltante</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="senalizacion_seguridad_faltante"
