<!-- Modal -->
<div class="modal fade" id="modal-inspecciones" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <form id="modal-form" class='w-full relative'>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6 mt-3">
                                <p class="font-bold text-lg">Empresa:</p>
                                <select id="select-enterprise" name="enterprise_id">
                            ...
                            {{-- PARQUE A ELEGIR --}}
                            <div class="col-6 mt-3">
                                <p class="font-bold text-lg">Parque:</p>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <select id="select-tecnico" name="tecnico_id">
                                    <option value="" disabled selected>Selecciona un tecnico</option>
                                </select>
                                <label id="tecnico_id_error" class="text-sm text-red-500 tracking-wide mb-3"></label>
                            </div>
                        </div>
                        <div class='row'>
                            {{-- FECHA ELEGIR --}}
